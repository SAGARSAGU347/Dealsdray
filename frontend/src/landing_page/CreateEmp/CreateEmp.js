...
function CreateEmp() {
  return (
    ...
    <div class="container mt-5">
        <form id="myForm" method='post' action='http://localhost:3000/createemp'>
            <div class="form-group row">
                <label for="name" class="col-sm-2 col-form-label">Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" placeholder="Enter your name" name="employee[name]" required />
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="email" placeholder="Enter your email" name="employee[email]" required />
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="Number" class="form-control" id="mobile" placeholder="Enter your mobile number" name="employee[mobileNumber]" required />
                </div>
            </div>
            <div class="form-group row">
